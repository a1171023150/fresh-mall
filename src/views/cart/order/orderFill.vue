<template>
  <div class="order-fill">
      ...
      <van-cell-group title="支付方式">
        <van-cell v-for="item in payList" :key="item.type">
          ...
          <template slot="right-icon">
            <van-radio :name="item.type" checked-color="#de1c31" />
          </template>
        </van-cell>
      </van-cell-group>
    </van-radio-group>
      ...
      <van-cell>
        <template slot="title">
          <div @click="showInfo = true">
            ...
            <van-icon name="question-o" color="#de1c31" />
          </div>
        </template>
        <template slot="right-icon">
    ...
    >
      ...
      <van-button type="danger" round size="small" @click="showInfo=false">确定</van-button>
    </van-popup>
    <van-cell-group>
