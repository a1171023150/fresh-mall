<template>
  <div class="mine">
    ...
    <van-cell title="我的订单" color="red" is-link value="查看全部订单" @click="getOrder(-1)" />
    <van-grid>
      <van-grid-item
    ...
    <van-cell-group>
      <van-cell title="我的收货地址" is-link @click="checkClick('/mine/myaddress')" />
      <van-cell title="联系客服" is-link @click="onPhoneClick" />
      <van-cell title="意见反馈" is-link @click="onCommentClick" />
    </van-cell-group>
    <div class="version">当前版本9.9.9</div>
  </div>
</template>
<script>
