<template>
  <div class="login">
    ...
    <van-cell-group>
      ...
      <van-button type="danger" class="login-button" round :disabled="disabled" @click="onLogin">登录</van-button>
    </van-cell-group>
...
export default {
  ...
  methods: {
    ...
    onLogin() {
      ...
      this.$toast("登录成功");
      this.syncUserInfo(this.message);
      this.$router.back();
    },
    onPartyLogin() {
      this.$toast("第三方登录还没有开通哦！");
    }
  },
  beforeDestroy() {
